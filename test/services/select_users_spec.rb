...
So, in this case, for this particular "query" service, only argument checing policies should be tested, and maybe the fact that service just return the gateway answer. And creating a gateway for test purposes at the domain business logic level might be just waste of time, but let's look into it again at the interface layer of the domain service.
=end
